		...
		switch(state)
		{
			case 1: //start
				...
				case 11:  //IDENTIFIER
					...
					break;
				case 60:
					current_pos--; if(g==1) printf("\nLine No.%d: Lexical Error: IDENTIFIER '%s' exceeds the maximum length of 30\n",tk.lno,tk.lexeme); tk.type=ERROR; return tk;
