...
List of terminals
*/
char* terminals[NO_OF_TERMINALS] = {"SEMICOLON","KEYWORD_INT", "KEYWORD_STRING" , "KEYWORD_FLOAT", "IDENTIFIER", "COMMA","KEYWORD_IF" ,"KEYWORD_ELSE" ,"KEYWORD_WHILE", "PARENTHESES_CLOSED","PARENTHESES_OPEN" , 
